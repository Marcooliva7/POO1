...
import p146_EstudianteGUI_V2.Utileria;
...
public class App extends JFrame implements ActionListener {
    ...
    public App() {
        ...
        jdlAcercdade.setSize(500,300);
        jdlAcercdade.setLocationRelativeTo(null);
        lblDatos = new JLabel("<html>PROGRAMACION ORIENTADA A OBJETOS 1<br> Marco Antonio Oliva<br>olivasantos31@gmail.com </html>", JLabel.CENTER);
    ...
    public void mostrarDatos(int ren){
        ...
        txtSexo.setText(Double.toString((datos.get(ren).getSexo())));
    ...
    public void cargarDatos() {
        ...
        obj[3] = datos.get(i).getDescripcion();
        obj[3] = datos.get(i).getSalario();
        modelo.addRow(obj);
        }
    }
    ...
    public void guardarCampos() {
        ...
        est.setSexo( Double.parseDouble(txtSexo.getText()) );
